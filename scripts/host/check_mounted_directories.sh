...
#        Please make sure that 'mavinbeh/magento2.debian_buster' Vagrant box was downloaded successfully (if not, this may help http://stackoverflow.com/questions/35519389/vagrant-cannot-find-box)
